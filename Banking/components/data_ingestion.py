...
class DataIngestion:
    ...
    def download_data(self) -> str:
        try:
            ...
            raw_file_path = os.path.join(raw_data_dir,banking_file_name )
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            banking_dataframe = pd.read_csv(banking_file_path)
            ...
            train_set, test_set = train_test_split(banking_dataframe, test_size=0.2, random_state=42)
